...
<body>
<h2 class="text-white text-center font-weight-bold bg-success" style="font-size: 55px;"> Laborateries Enrollment  </h2>
<h3 class="text-center">( Detail as per lab registration )  </h3>
