...
//   
     ...
     $INSERT = "INSERT INTO patient(user,last,emails,mobileno,pass,conpass,blood,gender) values(?, ?, ?, ?, ?, ?,?,?)";
     //Prepare statement
     ...
     if ($rnum==0) {
      ...
      $stmt->bind_param("ssssssss",$user,$last,$emails,$mobileNumber,$pass,$conpass,$blood,$gender);
      $stmt->execute();
...
//$select="SELECT FROM patient where email"
